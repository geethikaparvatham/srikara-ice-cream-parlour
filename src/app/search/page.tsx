            ...
            {results.map((flavor, index) => (
              ...
              >
                <div className="relative w-full h-180px overflow-hidden bg-#0B2E59/5">
                  ...
                  <div className="absolute top-3 left-3 bg-white/ dark:bg-[#0A2540]/ backdrop-blur-md px-3 py-1 rounded-full text-[10px] font-extrabold text-#0B2E59 border border-brand-yellow shadow-sm flex items-center space-x-1">

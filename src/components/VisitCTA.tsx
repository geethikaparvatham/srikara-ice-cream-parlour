    ...
    <section className="relative w-full py-24 flex items-center justify-center overflow-hidden bg-black select-none">
      ...
      <div className="relative max-w-4xl mx-auto px-4 text-center text-white z-10 flex flex-col items-center">
        ...
        >
          <a
            href="tel:9030303222"
            className="flex items-center justify-center space-x-2 bg-white text-[#0B2E59] hover:bg-white/95 px-8 py-4 rounded-full font-extrabold text-base w-full sm:w-60 shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300"
          >

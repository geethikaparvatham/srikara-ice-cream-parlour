...
const BADGES = [
  ...
  { icon: Star, label: "Premium Taste", color: "bg-[#005BFF]/10 text-[#0B2E59] dark:text-[#FFF8EC] border-[#005BFF]/20" },
  { icon: CheckCircle, label: "Trusted Brand", color: "bg-[#0B2E59]/10 text-[#0B2E59] dark:text-[#FFF8EC] border-[#0B2E59]/20" },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <h4 className="text-sm font-extrabold text-[#0B2E59] dark:text-[#FFF8EC]">Masqati Retailer</h4>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm sm:text-base text-[#0B2E59] dark:text-[#FFF8EC]/70 leading-relaxed">
